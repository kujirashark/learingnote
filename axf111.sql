...
CREATE TABLE `axf_cart` (
  ...
  `is_select` int(1) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `user` (`user_id`),
  KEY `goods` (`goods_id`),
  CONSTRAINT `axf_cart_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `axf_users` (`id`),
  CONSTRAINT `axf_cart_ibfk_2` FOREIGN KEY (`goods_id`) REFERENCES `axf_goods` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `axf_cart` VALUES (19, 4, 3, 1, 1);
INSERT INTO `axf_cart` VALUES (20, 4, 532, 1, 1);
COMMIT;
...
CREATE TABLE `axf_foodtypes` (
  ...
  `childtypenames` varchar(200) DEFAULT NULL,
  `typesort` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `axf_goods` (
  ...
  `productlongname` varchar(200) DEFAULT NULL,
  `isxf` int(11) DEFAULT '1',
  `pmdesc` varchar(100) DEFAULT NULL,
  `specifics` varchar(100) DEFAULT NULL,
  `price` float DEFAULT '0',
  `marketprice` float DEFAULT '1',
  `categoryid` varchar(16) DEFAULT NULL,
  `childcid` varchar(16) DEFAULT NULL,
  `childcidname` varchar(200) DEFAULT NULL,
  `dealerid` varchar(16) DEFAULT NULL,
  `storenums` int(11) DEFAULT '1',
  `productnum` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `axf_mainshow` (
  ...
  `trackid` varchar(16) DEFAULT NULL,
  `categoryid` varchar(16) DEFAULT NULL,
  `brandname` varchar(100) DEFAULT NULL,
  `img1` varchar(200) DEFAULT NULL,
  `childcid1` varchar(16) DEFAULT NULL,
  `productid1` varchar(16) DEFAULT NULL,
  `longname1` varchar(100) DEFAULT NULL,
  `price1` float DEFAULT '0',
  `marketprice1` float DEFAULT '1',
  `img2` varchar(200) DEFAULT NULL,
  `childcid2` varchar(16) DEFAULT NULL,
  `productid2` varchar(16) DEFAULT NULL,
  `longname2` varchar(100) DEFAULT NULL,
  `price2` float DEFAULT '0',
  `marketprice2` float DEFAULT '1',
  `img3` varchar(200) DEFAULT NULL,
  `childcid3` varchar(16) DEFAULT NULL,
  `productid3` varchar(16) DEFAULT NULL,
  `longname3` varchar(100) DEFAULT NULL,
  `price3` float DEFAULT '0',
  `marketprice3` float DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `axf_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `o_num` varchar(64) DEFAULT NULL,
  `o_status` int(11) DEFAULT '0',
  `o_create` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user` (`user_id`),
  CONSTRAINT `axf_order_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `axf_users` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `axf_order` VALUES (4, 4, 'ca9971391534', 1, '2018-06-06 11:26:02');
INSERT INTO `axf_order` VALUES (5, 4, 'ca6436158972', 1, '2018-06-06 11:27:07');
INSERT INTO `axf_order` VALUES (6, 4, 'ca9637288442', 0, '2018-06-06 11:29:35');
INSERT INTO `axf_order` VALUES (7, 4, 'ca5787269839', 0, '2018-06-06 11:37:44');
INSERT INTO `axf_order` VALUES (8, 4, 'ca3766182311', 0, '2018-06-06 11:38:00');
INSERT INTO `axf_order` VALUES (9, 4, 'ca7915457817', 1, '2018-06-06 11:38:13');
INSERT INTO `axf_order` VALUES (10, 4, 'ca5519574967', 0, '2018-06-06 11:38:27');
INSERT INTO `axf_order` VALUES (11, 4, 'ca6974583747', 0, '2018-06-06 11:39:39');
INSERT INTO `axf_order` VALUES (12, 4, 'ca8297866255', 0, '2018-06-06 11:39:48');
INSERT INTO `axf_order` VALUES (13, 4, 'ca4129834241', 0, '2018-06-06 11:41:52');
INSERT INTO `axf_order` VALUES (14, 4, 'ca9988564433', 0, '2018-06-06 12:40:00');
INSERT INTO `axf_order` VALUES (15, 4, 'ca4853982458', 0, '2018-06-06 12:40:11');
INSERT INTO `axf_order` VALUES (16, 4, 'ca9117436618', 1, '2018-06-07 01:46:53');
INSERT INTO `axf_order` VALUES (17, 4, 'ca4958624583', 1, '2018-06-07 02:05:27');
INSERT INTO `axf_order` VALUES (18, 4, 'ca5952422826', 0, '2018-06-07 03:05:47');
INSERT INTO `axf_order` VALUES (19, 4, 'ca6191655527', 1, '2018-06-07 03:05:59');
INSERT INTO `axf_order` VALUES (20, 4, 'ca3838196949', 1, '2018-06-07 04:31:58');
INSERT INTO `axf_order` VALUES (21, 4, 'ca7926874926', 1, '2018-06-07 04:52:44');
INSERT INTO `axf_order` VALUES (22, 4, 'ca4458536522', 0, '2018-06-07 04:53:54');
INSERT INTO `axf_order` VALUES (23, 4, 'ca8427267293', 1, '2018-06-07 04:55:38');
INSERT INTO `axf_order` VALUES (24, 4, 'ca4273925875', 0, '2018-06-07 04:56:45');
INSERT INTO `axf_order` VALUES (25, 4, 'ca7524754754', 1, '2018-06-07 04:58:29');
INSERT INTO `axf_order` VALUES (26, 4, 'ca7975434193', 1, '2018-06-07 06:02:13');
INSERT INTO `axf_order` VALUES (27, 4, 'ca3826511688', 0, '2018-06-07 06:04:09');
INSERT INTO `axf_order` VALUES (28, 4, 'ca6664161843', 1, '2018-06-07 06:06:01');
COMMIT;
...
CREATE TABLE `axf_order_goods` (
  ...
  KEY `goods` (`goods_id`),
  KEY `orders` (`order_id`),
  CONSTRAINT `axf_order_goods_ibfk_1` FOREIGN KEY (`goods_id`) REFERENCES `axf_goods` (`id`),
  CONSTRAINT `axf_order_goods_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `axf_order` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `axf_order_goods` VALUES (1, 495, 4, 5);
INSERT INTO `axf_order_goods` VALUES (2, 495, 5, 5);
INSERT INTO `axf_order_goods` VALUES (3, 495, 6, 5);
INSERT INTO `axf_order_goods` VALUES (4, 496, 13, 2);
INSERT INTO `axf_order_goods` VALUES (5, 496, 16, 1);
INSERT INTO `axf_order_goods` VALUES (6, 495, 16, 2);
INSERT INTO `axf_order_goods` VALUES (7, 497, 23, 2);
INSERT INTO `axf_order_goods` VALUES (8, 497, 25, 1);
INSERT INTO `axf_order_goods` VALUES (9, 73, 26, 2);
INSERT INTO `axf_order_goods` VALUES (10, 2, 28, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `axf_users` VALUES (1, 'admin', '123', NULL, b'0', NULL, b'0');
INSERT INTO `axf_users` VALUES (2, 'add', '123', '445144399@qq.com', b'0', NULL, b'0');
INSERT INTO `axf_users` VALUES (4, 'coco', 'pbkdf2_sha256$36000$dP6eyDxZaIjD$KSqLtL4TjhhRmFLwA96JCBwUvuy/KH+28Qa1TKl311s=', '3231@126.com', b'0', 'icons/avatar_iQLuH1K.png', b'0');
COMMIT;
...
CREATE TABLE `axf_users_ticket` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user_id`),
  CONSTRAINT `axf_users_ticket_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `axf_users` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `axf_users_ticket` VALUES (15, 4, 'TK_t4EuXYi,xfiF1Ft4dxzvI1ZFVo5lRr', '2018-06-08 01:42:54');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `django_migrations` VALUES (1, 'contenttypes', '0001_initial', '2018-06-04 06:21:55.106256');
INSERT INTO `django_migrations` VALUES (2, 'auth', '0001_initial', '2018-06-04 06:21:55.304495');
INSERT INTO `django_migrations` VALUES (3, 'admin', '0001_initial', '2018-06-04 06:21:55.350180');
INSERT INTO `django_migrations` VALUES (4, 'admin', '0002_logentry_remove_auto_add', '2018-06-04 06:21:55.374906');
INSERT INTO `django_migrations` VALUES (5, 'contenttypes', '0002_remove_content_type_name', '2018-06-04 06:21:55.424348');
INSERT INTO `django_migrations` VALUES (6, 'auth', '0002_alter_permission_name_max_length', '2018-06-04 06:21:55.439515');
INSERT INTO `django_migrations` VALUES (7, 'auth', '0003_alter_user_email_max_length', '2018-06-04 06:21:55.461319');
INSERT INTO `django_migrations` VALUES (8, 'auth', '0004_alter_user_username_opts', '2018-06-04 06:21:55.471776');
INSERT INTO `django_migrations` VALUES (9, 'auth', '0005_alter_user_last_login_null', '2018-06-04 06:21:55.492179');
INSERT INTO `django_migrations` VALUES (10, 'auth', '0006_require_contenttypes_0002', '2018-06-04 06:21:55.494561');
INSERT INTO `django_migrations` VALUES (11, 'auth', '0007_alter_validators_add_error_messages', '2018-06-04 06:21:55.503422');
INSERT INTO `django_migrations` VALUES (12, 'auth', '0008_alter_user_username_max_length', '2018-06-04 06:21:55.526207');
INSERT INTO `django_migrations` VALUES (13, 'sessions', '0001_initial', '2018-06-04 06:21:55.546568');
COMMIT;
